...
export const ThemeButton = () => {
  ...
  return (
    ...
    >
      ...
      <span className="absolute left-1/2 top-1/2 aspect-square h-[550vw] w-[550vw] -translate-x-1/2 -translate-y-1/2 scale-0 rounded-full bg-brand-black-light blur-sm transition-all ease-linear duration-300 dark:scale-100 dark:animate-vanish-delay" />
    </button>
  );
};
